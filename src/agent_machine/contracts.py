...
def schema_by_kind(root: Path | None = None) -> dict[str, Path]:
    ...
    return {
        ...
        "AttestationDecision": base / "attestation-decision.schema.json",
        ...
        "ArtifactBoundary": base / "artifact-boundary.schema.json",
        "CacheTier": base / "cache-tier.schema.json",
        "CapabilityDeclaration": base / "capability-declaration.schema.json",
        "DeploymentReceipt": base / "deployment-receipt.schema.json",
        "EvalGateProfile": base / "eval-gate-profile.schema.json",
        ...
        "InteractionSafetyPack": base / "interaction-safety-pack.schema.json",
