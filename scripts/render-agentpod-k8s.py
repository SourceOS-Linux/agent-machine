#!/usr/bin/env python3
"""Render Kubernetes YAML from a Kubernetes AgentPod JSON object.

The renderer is intentionally narrow. It supports the first Kubernetes
`llama.cpp` + TopoLVM AgentPod shape, emits a deterministic skeleton manifest,
and can compare the rendered semantic YAML documents against the checked-in
skeleton under deploy/k8s/.
"""
